...
import { currentYear, formatDateTime } from '@/lib/utils'
            ...
            <div className="success-img">
                ...
                <section className='flex items-center flex-col'>
                    ...
                    <h2 className='header mb-6 max-w-[600px] text-center '>
                        Your <span className='text-green-500'>appointment request</span> has been made successfully submitted!
                    </h2>
                ...
                <section className='request-details'>
                    ...
                    <div className='flex items-center gap-3'>
                        <Image src={doctor?.image!} height={24} width={24} alt={doctor?.name!} />
